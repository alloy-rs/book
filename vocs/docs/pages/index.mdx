...
<div className="max-w-[1120px] mx-auto vp-doc relative px-[24px] mb-[64px] mt-[32px] md:px-0 md:mb-[32px]">
  ...
  <div className="flex justify-between flex-wrap mt-10">
      <a href="/building-with-alloy/best-practices/wrapping-a-provider" className="pr-2 w-1/4 max-lg:pb-3 max-sm:px-0 max-lg:w-1/2 max-sm:w-full z-0">
      ...
      <a href="/building-with-alloy/best-practices/signers-vs-ethereum-wallet" className="pl-2 pr-2 max-sm:px-0 max-lg:pb-3 max-lg:pr-0 w-1/4 max-lg:w-1/2 max-sm:w-full z-0">
