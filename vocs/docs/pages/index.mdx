  ...
  <div className="pt-[48px] max-sm:pt-0">
    <div className="max-sm:px-0 flex justify-between z-0 max-md:justify-center">
      <div className="space-y-8 max-w-[400px] flex flex-col items-start max-md:items-center">
        ...
        <div className="font-regular text-[21px] max-sm:text-[18px] text-[#919193] max-md:text-center">Connect applications to blockchains using <span className="text-black dark:text-white">perfomant</span>, <span className="text-black dark:text-white">intuitive</span>, and <span className="text-black dark:text-white">battle-tested</span> APIs.</div>
